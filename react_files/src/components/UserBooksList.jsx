                  ...
                  <td>
                    <Link to="#">
                      {book.book_status === "R" ? (
                        <button
                          onClick={() =>
                            handleBookStatus(book.book_active_id, "N")
                          }
                          className="btn btn-warning"
                        >
                          Book returned by {book.renter}?
                        </button>
                      ) : book.book_status === "N" ? (
                        <button
                          onClick={() =>
                            handleBookStatus(book.book_active_id, "A")
                          }
